...
values (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
       ...
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 1',
        'ClassicRingtone',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 2', 'Delay',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 3',
        'DiodeClipper',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 4',
        'MinimumViablePiano',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 5', 'PadSynth',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 6', 'Reverb',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 7', 'SineSynth',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 8', 'SOUL909',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 9', 'ElecBass1',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 10',
        'ElectroPiano',
        0),
       (nextval('hibernate_sequence'), current_timestamp, current_timestamp,
        (select id from app_user where user_name = 'dbuser1'), 'description 11',
        'LatelyBass',
        0);
